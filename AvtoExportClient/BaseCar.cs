...
namespace AvtoExportClient
{
    ...
    public class BaseCar
    {
        ...
        {
            НЕИспользуется = 0,                 // 0
            Заводской_Одинарный_ОбычнаяСталь,   // 75, 85
            Двойной_Титан,                      // 350, 360
            Двойной_УсиленнаяСталь              // 150, 160
        }

        public enum cистемаЗажигания
        { Контактная = 0, Бесконтактная }

        public enum системаВпрыска
        {
            Карбюратор = 0,
            BOSH_JETRONIC = 1
        }
        ...
        public _ТипАмортизаторов ТипАмортизаторов
        {
            ...
            {
                // Не используется
                if (ТипАмортизаторов == _ТипАмортизаторов.Масло
                    && value == _ТипАмортизаторов.ГазМасло)
                {
                    Цена += 75;
                }
                else
                if (ТипАмортизаторов == _ТипАмортизаторов.Масло
                    && value == _ТипАмортизаторов.Газ)
                {
                    Цена += 350;
                }
                ...
                if (ТипАмортизаторов == _ТипАмортизаторов.ГазМасло
                    && value == _ТипАмортизаторов.Газ)
                {
                    Цена += 275;
                }
                ...
                if (ТипАмортизаторов == _ТипАмортизаторов.Газ
                    && value == _ТипАмортизаторов.Масло)
                {
                    Цена -= 350;
                }
        ...
        public стабилизаторПоперечнойУчтойчивостиИМатериал СтабилизаторПоперечнойУчтойчивостиИМатериал
        {
            ...
            {
                // Не используется
                if (СтабилизаторПоперечнойУчтойчивостиИМатериал == стабилизаторПоперечнойУчтойчивостиИМатериал.НЕИспользуется
                    && value == стабилизаторПоперечнойУчтойчивостиИМатериал.Заводской_Одинарный_ОбычнаяСталь)
                {
                    Цена += 85;
                }
                ...
                if (СтабилизаторПоперечнойУчтойчивостиИМатериал == стабилизаторПоперечнойУчтойчивостиИМатериал.Заводской_Одинарный_ОбычнаяСталь
                    && value == стабилизаторПоперечнойУчтойчивостиИМатериал.Двойной_УсиленнаяСталь)
                {
                    Цена += 75;
                }
                ...
                if (СтабилизаторПоперечнойУчтойчивостиИМатериал == стабилизаторПоперечнойУчтойчивостиИМатериал.Двойной_Титан
                    && value == стабилизаторПоперечнойУчтойчивостиИМатериал.НЕИспользуется)
                {
                    Цена -= 360;
                }
                ...
                // Двойной_УсиленнаяСталь
                else if (СтабилизаторПоперечнойУчтойчивостиИМатериал == стабилизаторПоперечнойУчтойчивостиИМатериал.Двойной_УсиленнаяСталь
                    && value == стабилизаторПоперечнойУчтойчивостиИМатериал.НЕИспользуется)
                {
                    Цена -= 160;
                }
        ...
        public системаВпрыска ИспользуетсяСистемаВпрыска
        {
            get
            {
            ...
            set
            {
                if (ИспользуетсяСистемаВпрыска == системаВпрыска.BOSH_JETRONIC && value == системаВпрыска.Карбюратор)
                {
                    Цена -= 1000;
                }
                else if (ИспользуетсяСистемаВпрыска == системаВпрыска.BOSH_JETRONIC && value == системаВпрыска.Карбюратор)
                    Цена += 1000;
        ...
        public _Привод РеализуемыйПривод
        {
            ...
            {
                // Не используется
                if (РеализуемыйПривод == _Привод.Задний
                    && value == _Привод.Передний)
                {
                    Цена += 75;
                }
                else
                if (РеализуемыйПривод == _Привод.Задний
                    && value == _Привод.Полный)
                {
                    Цена += 350;
                }
                ...
                if (РеализуемыйПривод == _Привод.Передний
                    && value == _Привод.Полный)
                {
                    Цена += 275;
                }
                ...
                if (РеализуемыйПривод == _Привод.Полный
                    && value == _Привод.Задний)
                {
                    Цена -= 350;
                }
        ...
        private системаВпрыска используетсяСистемаВпрыска = системаВпрыска.Карбюратор; // Только для MTX машин и последних поколений VFTS
